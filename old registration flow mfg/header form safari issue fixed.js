/**
 * Medical Form Gateway - Complete Script
 * Safari Compatible | Handles Desktop + Mobile Forms
 * Replace your existing JavaScript with this entire code
 */
...
(function() {
  ...
  // ============================================
  const CONFIG = {
    baseUrl: 'https://widget.myfloridagreen.com/PatientEnrollment/Registration/',
    token: '4300570066004F00790036002F0068007800690051003D00-4300570066004F00790036002F0068007800690051003D00',
    emailRegex: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
  ...
  function buildRedirectUrl(email, phone) {
    ...
    return CONFIG.baseUrl +
           CONFIG.token +
           '%C2%B6' + encodeURIComponent(phone) +
           '%C2%B6' + encodeURIComponent(emailHex);
  }
  ...
  function initializeForm(form) {
    ...
    form.addEventListener('submit', function(event) {
      ...
      if (!newWindow) {
        // Popup was blocked
//         alert('Popup Blocked!\n\nPlease allow popups for this site to continue with your registration.');
